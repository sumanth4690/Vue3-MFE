...
const resolveModifiers = (key, modifiers, context, loc) => {
    ...
    for (let i = 0; i < modifiers.length; i++) {
        ...
        if (modifier === 'native' &&
            checkCompatEnabled("COMPILER_V_ON_NATIVE" /* COMPILER_V_ON_NATIVE */, context)) {
...
const _hoisted_1 = /*#__PURE__*/createBaseVNode("h1", null, "This is shell", -1);
const _hoisted_2 = /*#__PURE__*/createTextVNode("Remote");

function _sfc_render(_ctx, _cache) {
  const _component_remote = resolveComponent("remote");
  const _component_router_link = resolveComponent("router-link");
  const _component_routerView = resolveComponent("routerView");

  return (openBlock(), createElementBlock("div", null, [
    _hoisted_1,
    createVNode(_component_remote),
    createVNode(_component_router_link, { to: "/remote" }, {
      default: withCtx(() => [
        _hoisted_2
      ]),
      _: 1
...
const remotesMap = {
'remote':{url:'http://127.0.0.1:4173/assets/remoteEntry.js',format:'esm',from:'vite'}
};
...
const remote = defineAsyncComponent(() => __federation_method_getRemote("remote" , "./App").then(module=>__federation_method_wrapDefault(module, true)));
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: "/about",
      name: "about",
      component: () => __vitePreload(() => import('./AboutView.bc7077d5.js'),true?["assets/AboutView.bc7077d5.js","assets/AboutView.fe0787ef.css"]:void 0)
    },
    {
      path: "/remote",
      name: "remote",
...
export { _export_sfc, createBaseVNode, createElementBlock, openBlock };
